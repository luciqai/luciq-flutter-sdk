...
public class GlobalMocks {
    ...
    public static void setUp() throws NoSuchMethodException {
        ...
        reflection
                .when(() -> Reflection.getMethod(Class.forName("ai.luciq.library.Luciq"), "reportCurrentViewChange",
                       String.class))
        ...
        reflection
                .when(() -> Reflection.getMethod(Class.forName("ai.luciq.library.Luciq"), "setCustomBrandingImage",
        ...
        reflection
                .when(() -> Reflection.getMethod(Class.forName("ai.luciq.library.Luciq"), "setCurrentPlatform", int.class))
        ...
        reflection
                .when(() -> Reflection.getMethod(Class.forName("ai.luciq.apm.networking.APMNetworkLogger"), "log", long.class, long.class, String.class, String.class, long.class, String.class, String.class, String.class, String.class, String.class, long.class, int.class, String.class, String.class, String.class, String.class, APMCPNetworkLog.W3CExternalTraceAttributes.class))
        ...
        reflection
                .when(() -> Reflection.getMethod(Class.forName("ai.luciq.crash.CrashReporting"), "reportException",
        ...
        reflection.when(() -> Reflection.getMethod(Class.forName("ai.luciq.apm.APM"), "startUiTraceCP", String.class, Long.class, Long.class)).thenReturn(mStartUiTraceCP);
        ...
        reflection.when(() -> Reflection.getMethod(Class.forName("ai.luciq.apm.APM"), "reportScreenLoadingCP", Long.class, Long.class, Long.class)).thenReturn(mReportScreenLoadingCP);
        ...
        reflection.when(() -> Reflection.getMethod(Class.forName("ai.luciq.apm.APM"), "endScreenLoadingCP", Long.class, Long.class)).thenReturn(mEndScreenLoadingCP);


        Method mAddUserStepCp = MockReflected.class.getDeclaredMethod("addUserStep",
                long.class, String.class, String.class, String.class, String.class);
        mAddUserStepCp.setAccessible(true);
        reflection.when(() -> Reflection.getMethod(Class.forName("ai.luciq.library.Luciq"), "addUserStep",
