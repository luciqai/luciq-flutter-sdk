---
description: Find existing code patterns and examples in the Luciq Flutter SDK
---
...
- **Module pattern**: How feature modules are structured (static class, Pigeon API calls)
- **Pigeon pattern**: How platform channel APIs are defined
- **Test pattern**: How tests are structured (Mockito mocks, setup, assertions)
- **Model pattern**: How data models and enums are defined
- **Utility pattern**: How utilities like NavigatorObserver, Widget wrappers work
