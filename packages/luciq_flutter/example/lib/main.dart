...
void main() {
  runZonedGuarded(
    () {
      ...
      Luciq.setValueForStringWithKey('Replay Text', CustomTextPlaceHolderKey.repliesNotificationReplyButton);
      Luciq.setValueForStringWithKey('Dismiss Text', CustomTextPlaceHolderKey.repliesNotificationDismissButton);
