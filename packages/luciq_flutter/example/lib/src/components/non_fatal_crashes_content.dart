...
class _NonFatalCrashesContentState extends State<NonFatalCrashesContent> {
  void throwHandledException(dynamic error) {
    try {
      ...
      if (err is Error) {
        log(
          'throwHandledException: Crash report for ${err.runtimeType} is Sent!',
    ...
    return Column(
      children: [
        ...
        LuciqButton(
          ...
          onPressed: LuciqFlutterExampleMethodChannel.sendNativeNonFatalCrash,
        ),
        Form(
          key: crashFormKey,
          child: Column(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: LuciqTextField(
                      ...
                      key:
                          const Key("non_fatal_user_attribute_value_textfield"),
  ...
  void sendNonFatalCrash() {
    if (crashFormKey.currentState?.validate() == true) {
      ...
      CrashReporting.reportHandledCrash(
        Exception(crashNameController.text),
        null,
