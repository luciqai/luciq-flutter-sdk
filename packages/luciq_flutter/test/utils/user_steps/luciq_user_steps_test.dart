...
void main() {
  late MockLuciqHostApi mockLuciqHostApi;

  setUp(() {
    mockLuciqHostApi = MockLuciqHostApi();
    Luciq.$setHostApi(mockLuciqHostApi);
  });

  Widget buildTestWidget(Widget child) {
    return MaterialApp(home: LuciqUserSteps(child: child));
  }

  group('LuciqUserSteps Widget', () {
