...
- (void)setUp {
    self.mFeatureRequests = OCMClassMock([LCQFeatureRequests class]);
...
- (void)testSetEmailFieldRequired {
    ...
    OCMVerify([self.mFeatureRequests setEmailFieldRequired:YES forAction:LCQActionReportBug | LCQActionRequestNewFeature]);
}
