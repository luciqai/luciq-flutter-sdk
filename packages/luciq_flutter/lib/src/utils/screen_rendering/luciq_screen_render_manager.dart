...
@internal
class LuciqScreenRenderManager {
  ...
  late LuciqScreenRenderData _screenRenderForAutoUiTrace;
  late LuciqScreenRenderData _screenRenderForCustomUiTrace;
  ...
  final List<LuciqFrameData> _delayedFrames = [];
  ...
  LuciqScreenRenderManager._();

  static LuciqScreenRenderManager _instance = LuciqScreenRenderManager._();

  /// Returns the singleton instance of [LuciqScreenRenderManager].
  static LuciqScreenRenderManager get instance => _instance;
  ...
  /// Dispose LuciqScreenRenderManager by removing timings callback and cashed data.
  @internal
  void dispose() {
    try {
      _resetCachedFrameData();
  ...
  void _addWidgetBindingObserver() {
    ...
    if (!_isWidgetBindingObserverAdded) {
      _widgetsBinding!.addObserver(LuciqWidgetsBindingObserver.instance);
  ...
  void _removeWidgetBindingObserver() {
    ...
    if (_isWidgetBindingObserverAdded) {
      _widgetsBinding!.removeObserver(LuciqWidgetsBindingObserver.instance);
  ...
  Future<void> _initStaticValues() async {
    ...
    _screenRenderForAutoUiTrace = LuciqScreenRenderData(frameData: []);
    _screenRenderForCustomUiTrace = LuciqScreenRenderData(frameData: []);
  }
  ...
  /// params:
  ///   [LuciqScreenRenderData] screenRenderData.
  ...
  @visibleForTesting
  LuciqScreenRenderManager.init();

  @visibleForTesting
  // ignore: use_setters_to_change_properties
  static void setInstance(LuciqScreenRenderManager instance) {
    _instance = instance;
  }

  @visibleForTesting
  LuciqScreenRenderData get screenRenderForAutoUiTrace =>
      _screenRenderForAutoUiTrace;

  @visibleForTesting
  LuciqScreenRenderData get screenRenderForCustomUiTrace =>
      _screenRenderForCustomUiTrace;

  @visibleForTesting
  void setFrameData(LuciqScreenRenderData data) {
