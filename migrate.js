...
const REFACTOR_METHODS = [
  {
    ...
    searchReplace: [
      ...
      { search: 'ibg', replacement: 'lcq' },
      { search: 'package:instabug_flutter', replacement: 'package:luciq_flutter' },
      { search: 'import \'package:instabug_flutter', replacement: 'import \'package:luciq_flutter' },
      { search: 'from \'package:instabug_flutter', replacement: 'from \'package:luciq_flutter' },
    ],
    targetExtensions: [
      '.dart',
      '.yaml',
  ...
  },
  {
    ...
    searchReplace: [
      ...
      { search: 'com.instabug.flutter', replacement: 'ai.luciq.flutter' },
      { search: 'InstabugFlutterPlugin', replacement: 'LuciqFlutterPlugin' },
    ...
    ignoredDirs: ['node_modules', 'build', 'Pods', 'vendor', '.git', 'dist', 'coverage', '.dart_tool', '.pub-cache', '.pub', '.flutter-plugins', '.flutter-plugins-dependencies', '.packages', 'doc/api'],
    enabled: false,
  },
  {
