...
class WebViewHostApi {
  ...
  Future<void> setWebViewMonitoringEnabled(bool arg_isEnabled) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.WebViewHostApi.setWebViewMonitoringEnabled',
        codec,
  ...
  Future<void> setWebViewNetworkTrackingEnabled(bool arg_isEnabled) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.WebViewHostApi.setWebViewNetworkTrackingEnabled',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_isEnabled]) as List<Object?>?;
  ...
  Future<void> setWebViewUserInteractionsTrackingEnabled(
    ...
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.WebViewHostApi.setWebViewUserInteractionsTrackingEnabled',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_isEnabled]) as List<Object?>?;
