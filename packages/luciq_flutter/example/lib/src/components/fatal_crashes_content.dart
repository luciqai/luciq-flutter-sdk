    ...
    return Column(
      ...
      children: [
        ...
        LuciqButton(
          ...
          onPressed: LuciqFlutterExampleMethodChannel.sendNativeFatalCrash,
        ),
        LuciqButton(
          symanticLabel: 'fatal_crash_native_hang',
          text: 'Send Native Fatal Hang',
          key: const Key('fatal_crash_native_hang'),
          onPressed: LuciqFlutterExampleMethodChannel.sendNativeFatalHang,
        ),
        if (Platform.isAndroid)
          LuciqButton(
            ...
            onPressed: LuciqFlutterExampleMethodChannel.sendAnr,
          )
        else
        ...
        LuciqButton(
          ...
          onPressed: LuciqFlutterExampleMethodChannel.sendOom,
        ),
      ],
    );
  }
