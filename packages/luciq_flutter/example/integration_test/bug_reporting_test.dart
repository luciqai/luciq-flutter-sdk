      ...
      ($) async {
        ...
        await $.native2.enterText(
          NativeSelector(
              ...
              android: AndroidSelector(
                  resourceName:
                      'ai.luciq.flutter.example:id/instabug_edit_text_email')),
        ...
        await $.native2.tap(NativeSelector(
            ...
            android: AndroidSelector(
                resourceName:
                    'ai.luciq.flutter.example:id/instabug_bugreporting_send')));
...
// End gestures
    ...
    patrolTest('Multiple Screenshots in Repro Steps', ($) async {
      ...
      await $.native2.tap(NativeSelector(
        ...
        android: AndroidSelector(
            resourceName:
                'ai.luciq.flutter.example:id/instabug_text_view_repro_steps_disclaimer'),
      ));
      ...
      final screenshots = await $.native2.getNativeViews(NativeSelector(
        ...
        android: AndroidSelector(
            resourceName:
                'ai.luciq.flutter.example:id/ib_bug_repro_step_screenshot'),
      ));
