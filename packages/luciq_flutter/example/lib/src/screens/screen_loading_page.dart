...
class _ScreenLoadingPageState extends State<ScreenLoadingPage> {
  ...
  void _extendScreenLoadingTestingEnvironment() async {
    ...
    if (isScreenLoadingEnabled) {
      ...
      debugPrint(
        ...
        'https://docs.luciq.com/docs/flutter-apm-screen-loading#disablingenabling-screen-loading-tracking'
  ...
  Widget build(BuildContext context) {
    return Page(
      ...
      children: [
        const SectionTitle('6x LuciqCaptureScreen'),
        KeyedSubtree(
          key: _reloadKey,
        ...
        const SectionTitle('Dynamic Screen Loading list'),
        SizedBox(
          height: 100,
          child: Padding(
