...
4. **Affected Products**: Which SDK products were affected? (APM, Crash Reporting, Bug Reporting, Session Replay, Surveys, Chats, Feature Requests)
...
- [ ] Feature Requests
- [ ] Core SDK
- [ ] Network Logger (Dio Interceptor / HTTP Client)
