  ...
  static void setup(SurveysFlutterApi? api,
      {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.luciq_flutter.SurveysFlutterApi.onShowSurvey',
          codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.luciq_flutter.SurveysFlutterApi.onDismissSurvey',
          codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
...
class SurveysHostApi {
  ...
  Future<void> setEnabled(bool arg_isEnabled) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.SurveysHostApi.setEnabled', codec,
  ...
  Future<void> showSurveyIfAvailable() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.SurveysHostApi.showSurveyIfAvailable',
        codec,
        binaryMessenger: _binaryMessenger);
  ...
  Future<void> setAutoShowingEnabled(bool arg_isEnabled) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.SurveysHostApi.setAutoShowingEnabled',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_isEnabled]) as List<Object?>?;
  ...
  Future<void> setShouldShowWelcomeScreen(
    ...
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.SurveysHostApi.setShouldShowWelcomeScreen',
        codec,
        binaryMessenger: _binaryMessenger);
  ...
  Future<void> setAppStoreURL(String arg_appStoreURL) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.SurveysHostApi.setAppStoreURL', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
  ...
  Future<void> bindOnShowSurveyCallback() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.luciq_flutter.SurveysHostApi.bindOnShowSurveyCallback',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
