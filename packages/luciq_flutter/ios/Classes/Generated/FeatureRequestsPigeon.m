...
void FeatureRequestsHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FeatureRequestsHostApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.luciq_flutter.FeatureRequestsHostApi.show"
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.luciq_flutter.FeatureRequestsHostApi.setEmailFieldRequired"
        binaryMessenger:binaryMessenger
        codec:FeatureRequestsHostApiGetCodec()];
    if (api) {
