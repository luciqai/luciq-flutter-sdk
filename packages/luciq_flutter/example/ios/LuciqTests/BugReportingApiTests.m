...
- (void)setUp {
    self.mBugReporting = OCMClassMock([LCQBugReporting class]);
...
- (void)testShow {
    ...
    OCMVerify([self.mBugReporting showWithReportType:LCQBugReportingReportTypeBug options:LCQBugReportingOptionEmailFieldOptional | LCQBugReportingOptionDisablePostSendingDialog]);
}
...
- (void)testSetInvocationEvents {
    ...
    OCMVerify([self.mBugReporting setInvocationEvents:LCQInvocationEventFloatingButton | LCQInvocationEventScreenshot]);
}
...
- (void)testSetReportTypes {
    ...
    OCMVerify([self.mBugReporting setPromptOptionsEnabledReportTypes:LCQBugReportingReportTypeBug | LCQBugReportingReportTypeFeedback]);
}
...
- (void)testSetExtendedBugReportingMode {
    ...
    OCMVerify([self.mBugReporting setExtendedBugReportMode:LCQExtendedBugReportModeEnabledWithOptionalFields]);
}
...
- (void)testSetInvocationOptions {
    ...
    OCMVerify([self.mBugReporting setBugReportingOptions:LCQBugReportingOptionEmailFieldHidden | LCQBugReportingOptionCommentFieldRequired]);
}
...
- (void)testSetVideoRecordingFloatingButtonPosition {
    ...
    OCMVerify([self.mBugReporting setVideoRecordingFloatingButtonPosition:LCQPositionTopRight]);
}
...
- (void)testSetEnabledAttachmentTypes {
    ...
    OCMVerify([self.mBugReporting setEnabledAttachmentTypes:LCQAttachmentTypeScreenShot | LCQAttachmentTypeExtraScreenShot | LCQAttachmentTypeGalleryImage | LCQAttachmentTypeScreenRecording]);
}
...
- (void)testBindOnDismissCallback {
    LCQDismissType dismissType = LCQDismissTypeSubmit;
    LCQReportCategory reportType = LCQReportCategoryBug;
    FlutterError *error;
...
- (void)testSetCommentMinimumCharacterCountGivenReportTypes {
    ...
    OCMVerify([self.mBugReporting setCommentMinimumCharacterCount:limit.intValue forBugReportType:LCQBugReportingReportTypeBug | LCQBugReportingReportTypeQuestion]);
}
