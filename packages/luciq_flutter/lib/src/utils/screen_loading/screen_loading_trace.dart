class ScreenLoadingTrace {
  ...
  /// Start time in microseconds from a monotonic clock like [LuciqMontonicClock.now].
  ...
  // other timestamps should be sampled from a monotonic clock like [LuciqMontonicClock.now]
